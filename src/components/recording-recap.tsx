...
import { fetchRecap, useAnthropicKey, type RecapResult } from "@/lib/ai";

/**
 * Recording → title, summary & chapters. Uses the teleprompter narration (the
 * user can edit it here) plus the recording length, generated with Claude when
 * a key is connected. The Loom/Guidde-style "recording becomes metadata" step.
 */
  ...
  return (
    <Card className="p-5">
      ...
      <div className="mt-3 flex items-center gap-3">
        <Button onClick={generate} disabled={!aiKey || busy}>
